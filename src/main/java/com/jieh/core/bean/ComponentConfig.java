 ...
 *       &lt;sequence>
 *         &lt;element name="property" type="{http://www.jiehang.com/autumn/schema/components}PropertyConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ComponentConfig {
	...
	public String toString() {
		return "ComponentConfig [property=" + property + ", name=" + name + ", clazz=" + clazz + "]";
	}
